 ...
 * @author liangyi
 */
@Table(name = "team_member_pvp_free")
@Builder
@Data
@AllArgsConstructor
public class TeamMemberPVPFree implements Serializable, TeamMember {

    private static final long serialVersionUID = -5749413742573624453L;
    /**
     * PVP免费车队队员表主键ID
     */
    @Id
    ...
    public TeamMemberPVPFree(Long id, Long teamId, String uid, String username, String avatar, Byte userIdentity, Integer baojiLevel, Integer gameDanId, String gameDanName, Byte status, Date joinTime, Date gmtCreate, Date gmtModified) {
        this.id = id;
        this.teamId = teamId;
        this.uid = uid;
    ...
    /**
     * 获取车队队员状态, 0:待准备, 1:已准备, 3:开车后退出
     *
     * @return status - 车队队员状态, 0:待准备, 1:已准备, 3:开车后退出
     */
    @Override
    ...
    /**
     * 设置车队队员状态, 0:待准备, 1:已准备, 3:开车后退出
     *
     * @param status 车队队员状态, 0:待准备, 1:已准备, 3:开车后退出
     */
    @Override
