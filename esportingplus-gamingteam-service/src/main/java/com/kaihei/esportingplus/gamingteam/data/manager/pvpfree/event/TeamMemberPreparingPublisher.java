...
public class TeamMemberPreparingPublisher extends EventPublisher<TeamGamePVPFree> {
    ...
    protected void doPublish() {
        ...
        imTeamStatusChangeParams.setStatusEnum(ImTeamMemberStatusEnum.READY);
        ...
        log.info("发送容云准备消息 ->{}", imTeamStatusChangeParams);
