...
@Component
public class RefundNofityEventConsumer extends EventConsumer {
    ...
    public void updateOrder(RefundNofityEvent event) {
       LOGGER.info("退款回调通知后异步更新订单[{}]状态。",event.getOrder().getStatus());
        rpgOrderService.updateRefundOrder(event.getOrder());
    }
