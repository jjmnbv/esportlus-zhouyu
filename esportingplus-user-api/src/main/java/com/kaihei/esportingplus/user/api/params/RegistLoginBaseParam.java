...
public class RegistLoginBaseParam implements Serializable {
    ...
    public String getSa_distinct_id() {
        return sa_distinct_id;
    }

    public void setSa_distinct_id(String sa_distinct_id) {
        this.sa_distinct_id = sa_distinct_id;
    }
}
