...
public class MembersUserPointItemVo {
    /**
     * 自增主键
     */
    private Integer id;
    ...
    public MembersUserPointItemVo(Integer id, Integer userId, Integer itemType, Integer itemAcmount, Integer operationUserId, String instructions, Date createDatetime, String slug) {
        this.id = id;
        this.userId = userId;
