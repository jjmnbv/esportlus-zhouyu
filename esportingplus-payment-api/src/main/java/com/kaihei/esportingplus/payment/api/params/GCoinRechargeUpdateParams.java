 ...
 **/
@Validated
@ApiModel(value = "更新暴鸡币充值订单参数", description = "更新暴鸡币充值订单参数")
public class GCoinRechargeUpdateParams implements Serializable {
     ...
     * 主题
     */
    @ApiModelProperty(value = "主题", required = true, example = "请求主题")
    ...
    @ApiModelProperty(value = "回调URL notifyUrl", required = true, example = "回调URL")
