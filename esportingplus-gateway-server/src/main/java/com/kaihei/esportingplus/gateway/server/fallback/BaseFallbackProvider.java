        ...
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                ResponsePacket responsePacket = ResponsePacket
                        .onError(BizExceptionEnum.GATEWAY_FALBACK.getErrCode()
                                , StringUtils.formatTemplate(BizExceptionEnum.GATEWAY_FALBACK.getErrMsg()
                                        ,new String[]{serviceId.getDesc(),serviceId.getCode()})
                                        ,cause.getMessage());
