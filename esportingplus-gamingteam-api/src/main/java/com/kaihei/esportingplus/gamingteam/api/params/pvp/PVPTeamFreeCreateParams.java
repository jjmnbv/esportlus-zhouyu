...
@Data
public class PVPTeamFreeCreateParams implements JsonSerializable {
     ...
     * 游戏code
     */
    @NotNull(message = "车队类型Id不能为空")
    @Min(value = 1, message = "车队类型Id不能小于1")
    @ApiModelProperty(value = "车队类型Id", required = true, position = 1, example = "1")
...
//    private Byte playMode;
    ...
    @ApiModelProperty(value = "结算类型, 1:局; 2:小时", required = true, position = 1, example = "3")
    ...
    public Byte getPlayMode() {
        return ((byte) (PlayModeEnum.ACCOMPANY_PLAY.getCode()));
    }
}
