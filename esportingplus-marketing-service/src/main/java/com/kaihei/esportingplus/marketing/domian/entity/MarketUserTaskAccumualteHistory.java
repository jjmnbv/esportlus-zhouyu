...
@Table(name = "market_user_task_accumualte_history")
public class MarketUserTaskAccumualteHistory {
    /**
     * 主键
     */
    @Id
    ...
    public MarketUserTaskAccumualteHistory(Long id, Integer userId, Integer accumulate, Integer awardSnapshot, Integer type, Date batchDate, Date updateTime, Date createTime) {
        this.id = id;
        this.userId = userId;
    ...
    public MarketUserTaskAccumualteHistory() {
        super();
    }
