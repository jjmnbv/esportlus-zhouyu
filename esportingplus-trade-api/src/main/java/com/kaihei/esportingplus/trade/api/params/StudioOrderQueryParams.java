 ...
 * @author zhangfang
 */
@ApiModel("分页查询投诉单数据列表请求参数（工作室）")
@Validated
public class StudioOrderQueryParams extends PagingRequest implements Serializable {
    ...
    @ApiModelProperty(value = "订单状态status", required = false, position = 3, example = "0")
