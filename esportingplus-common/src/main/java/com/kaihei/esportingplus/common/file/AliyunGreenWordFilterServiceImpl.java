...
import com.kaihei.esportingplus.common.config.AliyunGreenConfig;
...
public class AliyunGreenWordFilterServiceImpl implements WordFilterService {
     ...
     * @throws UnsupportedEncodingException
     */
    private static TextScanRequest getTextScanRequest(String... works) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
    private static boolean analyseAliyunHttpResponse(HttpResponse httpResponse) throws UnsupportedEncodingException {
                    ...
                    if(200 == ((JSONObject)taskResult).getInteger("code")){
                        ...
                        for (Object sceneResult : sceneResults) {
                            ...
                            if("review".equals(suggestion)||"block".equals(suggestion)){
                                new RuntimeException(content + "中含有敏感词");
