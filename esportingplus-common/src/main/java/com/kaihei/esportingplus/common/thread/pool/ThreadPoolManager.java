...
import com.kaihei.esportingplus.common.thread.NamedThreadFactory;
import com.kaihei.esportingplus.common.thread.ThreadNames;
...
public final class ThreadPoolManager {
    ...
    public Executor getDefaultExecutor() {
        return pools.computeIfAbsent(ThreadNames.NS,s -> executorFactory.get(ExecutorFactory.ESPORTINGPLUS_COMMON));
    }

    public Executor getEventBusExecutor() {
        return pools.computeIfAbsent("event-bus", s -> executorFactory.get(ExecutorFactory.ESPORTINGPLUS_EVENT_BUS));
    }
    ...
    public ScheduledExecutorService getTaskTimer() {
        return (ScheduledExecutorService) pools.computeIfAbsent("task-timer"
