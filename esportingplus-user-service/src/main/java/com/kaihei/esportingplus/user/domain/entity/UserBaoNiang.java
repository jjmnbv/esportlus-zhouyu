...
public class UserBaoNiang {
    ...
    public UserBaoNiang(Integer id, String uid, Short game, String gamePicture, String personalVideo, Date updateTime, Date createTime, Short sectionStatus, Short status, Short levelStatus, Integer power, Date verifyTime, Integer tagId, Short gameDan, Short gameZone, Integer section, String assistantId, String tracking) {
        this.id = id;
        this.uid = uid;
        this.game = game;
