...
public class UserProperties {
    ...
    @Value("${python.freeteam.incrfreecount.url}")
    private String freeCountUrl;

    @Value("${python.freeteam.chances.info}")
    private String freeChancesInfo;

    @Value("${python.domain}")
    private String pythonDomain;

    @Value("${python.im.sendmessage.url}")
    ...
    public String getFreeChancesInfo() {
        return freeChancesInfo;
    }

    public void setFreeChancesInfo(String freeChancesInfo) {
        this.freeChancesInfo = freeChancesInfo;
    }

    public String getFreeCountUrl() {
        return freeCountUrl;
    }

    public void setFreeCountUrl(String freeCountUrl) {
        this.freeCountUrl = freeCountUrl;
    }
    ...
    public void setUserSendMessage(String userSendMessage) {
